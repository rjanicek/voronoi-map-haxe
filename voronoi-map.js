...
voronoimap.Html = function() { }
voronoimap.Html.__name__ = true;
...
voronoimap.Main.initializeUi = function() {
	...
	new js.JQuery("#imageFile").change(function(e) {
		haxe.Log.trace("file changed",{ fileName : "Main.hx", lineNumber : 108, className : "voronoimap.Main", methodName : "initializeUi"});
...
voronoimap.Main.generate = function() {
	...
	case "bitmap":
		...
		haxe.Log.trace(Std.parseInt(new js.JQuery("#imageThreshold").val()),{ fileName : "Main.hx", lineNumber : 195, className : "voronoimap.Main", methodName : "generate"});
